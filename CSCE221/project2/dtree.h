...
public:
    ...
    void printAccountsHelper(DNode* node) const;

    //helper function for deep copy
    DNode* copyTree(DNode* node);

    //retrieve helper
    DNode* retrieveHelper(int disc, DNode* node);
    ...
    void createArrayHelper(DNode* node, DNode* array, int& index);
    DNode* rebalanceHelper(DNode* array, int start, int end);

    //insert helpers
    bool insertHelper(Account newAcct, DNode*& node);
